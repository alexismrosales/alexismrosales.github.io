...
const Programs: ProgramsI = {
    ...
    ToDoList: {
        en: {
            Title: "todolist",
            date: "April 8 2023",
            description: "To-do list app using React and Spring Boot, with CRUD and MySQL.",
            content: (
                <span>
                    <img src="/img/Program/ToDoList.png" className={styles.img} />
                    <p>
                        <span className="font-bold">This is a web app </span>I made to practice my skills with React and Spring Boot(Java). It is a simple to do list where you can add, delete and mark as done the tasks you have to do.
                        <br /><br />
        ...
        es: {
            Title: "todolist",
            date: "Abril 8 2023",
            description: "Aplicación web de lista de tareas usando React y Spring Boot, con CRUD y MySQL",
            content: (
                <span>
                    <img src="/img/Program/ToDoList.png" className={styles.img} />
                    <p>
    ...
    DualSimplexAlgorithm: {
        en: {
            Title: "DualSimplexAlgorithm",
            date: "April 8 2023",
            description: "Program to solve linear programming problems using the dual simplex algorithm, built with Tkinter, Pandas, and Numpy.",
            content: (
                <span>
                    <img src="/img/Program/DualSimplexAlgorithm.png" className={styles.img} />
                    <p>
        ...
        es: {
            Title: "DualSimplexAlgorithm",
            date: "",
            description: "Programa para resolver problemas de programación lineal con el algoritmo dual simplex, desarrollado con Tkinter, Pandas y Numpy.",
            content: (
                <span>
                    <img src="/img/Program/DualSimplexAlgorithm.png" className={styles.img} />
                    <p>
    ...
    BestSubwayRoute: {
        en: {
            Title: "BestSubwayRoute",
            date: "",
            description: "Prolog program to find the best and worst CDMX subway routes based on parameters like time and transfers.",
            content: (
                <span>
                    <img src="/img/Program/BestSubwayRoute.png" className={styles.img} />
                    <p>
        ...
        es: {
            Title: "BestSubwayRoute",
            date: "",
            description: "Programa en Prolog para calcular las mejores y peores rutas del metro de CDMX según parámetros como tiempo y transferencias.",
            content: (
                <span>
                    <img src="/img/Program/BestSubwayRoute.png" className={styles.img} />
                    <p>
    ...
    SierpinskiTriangle: {
        en: {
            ...
            date: "",
            description: "Desktop program that draws the Sierpinski triangle fractal using OpenGL and GLUT based on the depth level.",
            content: (
                <span>
                    <img src="/img/Program/SierpinskiTriangle.png" className={styles.img} />
                    <p>
        ...
        es: {
            Title: "SierpinskiTriangle",
            date: "",
            description: "Programa de escritorio que dibuja el fractal del triángulo de Sierpinski usando OpenGL y GLUT, según el nivel de profundidad.",
            content: (
                <span>
                    <img src="/img/Program/SierpinskiTriangle.png" className={styles.img} />
                    <p>
    ...
    LongestCommonPrefix: {
        en: {
            ...
            date: "",
            description: "Unfinished web project solving the 'Longest Common Prefix' problem using brute force and divide and conquer, with algorithm animations.",
            content: (
                <span>
                    <img src="/img/Program/LongestCommonPrefix.png" className={styles.img} />
                    <p>
        ...
        es: {
            Title: "LongestCommonPrefix",
            date: "",
            description: "Proyecto web inacabado que resuelve el problema de 'Prefijo común más largo' usando fuerza bruta y divide y vencerás, mostrando animaciones del algoritmo.",
            content: (
                <span>
                    <img src="/img/Program/LongestCommonPrefix.png" className={styles.img} />
                    <p>
    ...
    TheGeniusOfTheStories: {
        en: {
            Title: "TheGeniusOfTheStories",
            date: "",
            description: "Game developed in my data structures course where the program guesses the story, movie, or novel you're thinking of using a binary tree. You can load or create a new database.",
            content: (
                <span>
                    <img src="/img/Program/TheGeniusOfTheStories.png" className={styles.img} />
        ...
        es: {
            Title: "TheGeniusOfTheStories",
            date: "",
            description: "Juego desarrollado en mi curso de estructuras de datos donde el programa intenta adivinar qué historia, película o novela piensas usando un árbol binario.",
            content: (
                <span>
                    <img src="/img/Program/TheGeniusOfTheStories.png" className={styles.img} />
                    <p>
