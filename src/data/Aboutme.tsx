    ...
    en : {
        ...
        Text : 
            <span>
                ...
                <br></br>
                Currently I am interested in AI (Machine Learning) and statistics, I'm a newbie on this topics but I would like to delve deeper into these areas of knowledge. 
                <br></br>
        ...
        Phrase :  
            <span>
                “Try to learn something about everything <br/> and <br/>everything about something.”<br/> Thomas Huxley
            </span>
    },
    es : {
        Title : 
        ...
        Text : 
            <span>
                ...
                <br></br>
                Actualmente estoy interesado en IA (Aprendizaje Automático) y estadística, soy un novato en estos temas, pero me gustaría profundizar en estas áreas del conocimiento.
                <br></br>
        ...
        Phrase :  
            <span>
                “Trata de aprender algo sobre todo y todo sobre algo.” <br/> Thomas Huxley
            </span>
    }
}
